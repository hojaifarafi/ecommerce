                                    ...
                                    <div class="wg-box">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="upload-image mb-16">
                                                <div class="item" id="gaimg" style="display: none">
                                                ...
                                                <div id="galUpload" class="item up-load">
                                                    <label class="uploadfile" for="gFile">
                                                        ...
                                                        <input type="file" id="gFile" name="images[]" accept="image/*"
                                                            multiple="" onclick="image_preview_galary()">
                                                    </label>
                                                </div>
                                            </div>
                                        </fieldset>
...
function image_preview_galary(){
    let img = document.getElementById('gFile');
    var pre1 = document.getElementById('gaimg');
    pre1.style.removeProperty('display');
