        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              ...
              <a href="{{ $slide->link }}" class="btn btn-primary btn-lg mt-3 animate animate_fade animate_btt animate_delay-7"
                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    ...
                    <div class="pc__info position-relative">
                      ...
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">${{$sproduct->sale_price}}</span>
                      </div>
                    </div>
                  </div>
                  @endforeach
            ...
            <div class="product-card product-card_style3 mb-3 mb-md-4 mb-xxl-5">
              <div class="pc__img-wrapper">
                <a href="{{ route('shop.product.details', $fproduct->slug) }}">
                  <img loading="lazy" src="{{ asset('uploads/products/thumbnails/' . $fproduct->image) }}" width="330" height="400"
